...
<div class="page-wrapper ">
                                ...
                                <div class="order_detail-top-box">
                                    ...
                                    <div class="form-group row width-100 mt-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button"
                                                    class="btn btn-primary save_order_btn show_popup ml-3">
    ...
    <div class="form-group col-12 text-center btm-btn">
        <button type="button" class="btn btn-primary save_order_btn"><i class="fa fa-save"></i> {{trans('lang.save')}}
        </button>
        ...
        ref.get().then(async function (snapshots) {
            ...
            if (order.payment_method) {
                ...
                if (order.payment_method == "stripe") {
                    ...
                    payment_method = '<img alt="image" src="' + image + '"  width="30%" style="height: auto;">';
            ...
            if (order.workerId != '' && order.workerId != null && order.workerId != undefined) {
                ...
                if (workerDetail == '' || workerDetail == undefined) {
                    ...
                    $('#worker_email').html(workerDetail.email);
                    $('#worker_address').html(workerDetail.address);
                    $('#worker_phone').html(workerDetail.phoneNumber);
            ...
            if (order.provider.author != '' && order.provider.author != null && order.provider.author != undefined) {
                ...
                if (providerDetail == '' || providerDetail == undefined) {
                    ...
                    $('#provider_email').html(providerDetail.email);
                    $('#provider_phone').html(providerDetail.phoneNumber);
    ...
    function buildRatingsAndReviewsHTML(bookingOrder, userreviewsnapshot) {
        ...
        allreviewdata.forEach((listval) => {
            ...
            if (provider.id == val.productId) {
                ...
                reviewhtml = reviewhtml + '<a href="javascript:void(0);"><img alt="#" src="' + provider.photos[0] + '" class=" img-circle img-size-32 mr-2" style="width:60px;height:60px"></a>';
