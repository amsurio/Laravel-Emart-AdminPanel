        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{!! route('ondemand.workers.index') !!}">{{trans('lang.worker_table')}}</a>
                </li>
                @else
                <li class="breadcrumb-item"><a
                        href="{!! route('ondemand.workers.index',@$_GET['id']) !!}">{{trans('lang.worker_table')}}</a>
                </li>
                @endif
...
<script>
    ...
    $(document).ready(function () {
        ...
        workersRef.get().then(async function (snapshots) {
            ...
            $(".email").val(workerData.email)
            $(".phone").val(workerData.phoneNumber);
