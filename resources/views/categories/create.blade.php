            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-check row width-100" id="show_in_home" style="display: none;">
                                            ...
                                            <div class="form-text text-muted w-50">
                                                {{ trans('lang.show_in_home_desc') }}<span id="forsection"></span></div>
                                        </div>
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        <button type="button" class="btn btn-primary save_category_btn"><i class="fa fa-save"></i>
                            {{ trans('lang.save') }}
                        </button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                ...
                snapshots.docs.forEach((listval) => {
                    ...
                    if (data.serviceTypeFlag == "delivery-service" || data.serviceTypeFlag ==
                        ...
                        $('#section_id').append($("<option></option>")
                            .attr("value", data.id).attr("data-service-type", data
                                .serviceTypeFlag)
                            .text(data.name));
                    }
                })
            ...
            ref_review_attributes.get().then(async function(snapshots) {
                ...
                snapshots.docs.forEach((listval) => {
                    ...
                    ra_html += '<input type="checkbox" id="review_attribute_' + data.id +
                        '" value="' + data.id + '">';
                    ra_html += '<label class="col-3 control-label" for="review_attribute_' +
            ...
            $(".save_category_btn").click(async function() {
                ...
                if (title == '') {
                    ...
                    if (show_in_homepage) {
                        ...
                        await database.collection('vendor_categories').where('show_in_homepage', "==",
                            true).where("section_id", "==", section_id).get().then(async function(
                            snapshots) {
        ...
        $("#category_image").resizeImg({
            ...
            callback: function(base64str) {
                ...
                fileName = filename;
                $(".cat_image").empty();
                $(".cat_image").append('<img class="rounded" style="width:50px" src="' + photo +
                    '" alt="image">');
                $("#category_image").val('');
