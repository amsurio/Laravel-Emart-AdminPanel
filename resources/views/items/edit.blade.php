                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <select id="item_vendor" onchange="checkVendorSection();" class="form-control" required>
            ...
            if (product.hasOwnProperty("isDigitalProduct") && product.hasOwnProperty("digitalProduct")) {
                ...
                if (product.digitalProduct) {
                    ...
                    if (ext == 'zip') {
                        ...
                        $("#uploding_zip").html('<span class="image-item zip-file mt-2"><span class="" data-itemid="' + product.id + '" data-file="' + product.digitalProduct + '"></span><img width="100px" height="auto" src="' + product.digitalProduct + '"></span>');
        ...
        $(".save_item_btn").click(async function () {
            ...
            if (name == '') {
                ...
                if (attributes.length > 0 && variants.length > 0) {
                    if (error > 0) {
                        alert('Please add your variants price and quantity');
                        return false;
                    }
            ...
            return function (e) {
                ...
                if (ext == "jpg" || ext == "jpeg" || ext == "png" || ext == "gif" || ext == "zip" || ext == "pdf") {
                    ...
                    if (ext == "zip") {
                        ...
                        $("#uploding_zip").html('<span class="image-item zip-file"><span class=""  data-file="' + filePayload + '"></span><img width="100px" id="" height="auto" src="' + filePayload + '"></span>');
                    }
            ...
            if (listval.id == item_vendor) {
                ...
                sections_list.forEach((sections) => {
                    if (sections.id == section) {
                        if (sections.dine_in_active) {
                            is_activedine_in = true;
                        }
