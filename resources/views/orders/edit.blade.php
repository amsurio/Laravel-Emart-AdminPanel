...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="form-group col-12 text-center btm-btn non-printable">
            <button type="button" class="btn btn-primary save_order_btn d-none"><i
    ...
    <script type="text/javascript">
        ...
        function buildHTMLProductstotal(snapshotsProducts) {
            ...
            if (intRegex.test(adminCommission) || floatRegex.test(adminCommission)) {
                ...
                html = html + '<tr><td class="label"><small>{{trans("lang.admin_commission")}} ' + adminCommHtml + '</small> </td><td style="color:red"><small>( ' + adminCommission_val + ' )</small></td></tr>';
