...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $(".save_coupon_btn").click(function () {
      ...
      database.collection('parcel_coupons').where('code', '==', code).get().then(async function (snapshot) {
        ...
        if (code == '') {
          ...
          storeImageData().then(IMG => {
            ...
            database.collection('parcel_coupons').doc(id).set({ 'code': code, 'description': description, 'discount': discount, 'expiresAt': expiresAt, 'isEnabled': isEnabled, 'id': id, 'discountType': discountType, 'image': IMG }).then(function (result) {
