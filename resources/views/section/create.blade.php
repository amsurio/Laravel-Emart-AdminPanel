    ...
    function handleFileSelect(evt) {
        ...
        reader.onload = (function (theFile) {
            return function (e) {
                ...
                fileName=filename;
                $(".cat_image").empty();
                $(".cat_image").append('<span class="image-item" id="photo_user"><span class="remove-btn" data-id="user-remove" data-img="' + photo + '"><i class="fa fa-remove"></i></span><img class="rounded" style="width:50px" src="' + photo + '" alt="image"></span>');
            };
        })(f);
