                    ...
                    <div class="vendor_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_apple_pay_secret')}}</label>
                                <div class="col-7">
                                    <input type="password" class="form-control stripe_secret">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_apple_pay_secret_help') !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row width-100">
                                ...
                                <div class="col-7">
                                    <input type="password" class="form-control apple_pay_merchant_id">
                                </div>
                            </div>
                        </fieldset>
                    </div>
