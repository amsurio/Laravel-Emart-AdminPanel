        ...
        $(document).ready(function () {
            ...
            ref.get().then(async function (snapshots) {
                ...
                try {
                    ...
                    $(".provider_logo_img_thumb").html('<img class="rounded" style="width:100px;padding:15px" src="' + providerLogo + '" alt="image">');
                    workerLogo = globalSettings.workerLogo;
                    $(".worker_logo_img_thumb").html('<img class="rounded" style="width:100px;padding:15px" src="' + workerLogo + '" alt="image">');
            ...
            appBannerImage.get().then(async function (snapshots) {
                ...
                jQuery("#data-table_processing").hide();
                 if (bannerImage == undefined) {
                    database.collection('settings').doc('Banner').set({'url':''});
                }
                if (bannerImage.hasOwnProperty('url') && bannerImage.url != '') {
