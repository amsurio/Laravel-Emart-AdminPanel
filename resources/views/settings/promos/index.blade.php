...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor">{{trans('lang.promo')}} <span class="storeTitle"></span></h3>
        ...
        <div class="col-md-7 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{trans('lang.promo_table')}}</li>
                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            <li class="nav-item">
                                <a class="nav-link active" href="{!! url()->current() !!}"><i
                                            class="fa fa-list mr-2"></i>{{trans('lang.promo_table')}}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('settings.promos.create') !!}"><i
                                            class="fa fa-plus mr-2"></i>{{trans('lang.promo_create')}}</a>
                            </li>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        html = html + '<a id="' + val.id + '" name="promo_delete_btn" class="do_not_delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a>';
        <?php }?>
    ...
    $(document).on("click", "a[name='promo_delete_btn']", function (e) {
        var id = this.id;
        database.collection('promos').doc(id).delete().then(function () {
